...
// import {toHaveTextContent} from '@testing-library/jest-native' // import matchers needed or import all extend-expect
...
describe("RepositoryList", () => {
  describe("RepositoryListContainer", () => {
    it("renders repository information correctly", () => {
      ...
      const { debug, getByText, getAllByTestId } = render(
